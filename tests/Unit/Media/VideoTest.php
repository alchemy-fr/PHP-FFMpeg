...
class VideoTest extends AbstractStreamableTestCase
{
    ...
    public function testAddFiltersAddsAFilter()
    {
        ...
        $filter = $this->createMock('FFMpeg\Filters\Video\VideoFilterInterface');
    ...
    public function testAddAudioFilterAddsAFilter()
    {
        ...
        $filter = $this->createMock('FFMpeg\Filters\Audio\AudioFilterInterface');
    ...
    public function provideSaveData()
    {
        ...
        $format2 = $this->createMock('FFMpeg\Format\VideoInterface');
        ...
        $audioFormat = $this->createMock('FFMpeg\Format\AudioInterface');
        ...
        $audioVideoFormat = $this->createMock('FFMpeg\Format\VideoInterface');
        ...
        $audioVideoFormatSinglePass = $this->createMock('FFMpeg\Format\VideoInterface');
        ...
        $formatExtra = $this->createMock('FFMpeg\Format\VideoInterface');
        ...
        $formatExtra2 = $this->createMock('FFMpeg\Format\VideoInterface');
        ...
        $listeners = array($this->createMock('Alchemy\BinaryDriver\Listeners\ListenerInterface'));
